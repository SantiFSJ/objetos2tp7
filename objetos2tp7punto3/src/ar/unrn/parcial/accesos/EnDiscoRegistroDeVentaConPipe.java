...
public class EnDiscoRegistroDeVentaConPipe implements RepositorioVentas {
	@Override
	public void archivar(LocalDateTime fechaVenta, int cantidad, Double montoTotal) throws IOException {
